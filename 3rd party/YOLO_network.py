...
class YOLO_TF:
	...
	filewrite_txt = False
	disp_console = True
	weights_file = '/Users/beatajohansson/Desktop/ROLO/weights/yolo/yolov1.ckpt'
	alpha = 0.1
	threshold = 0.08
	iou_threshold = 0.5
	num_class = 20
...
def main(argvs):
	...
	out_fold = os.path.join(root_folder, sequence_name, 'yolo_out_test1234/')
