...
# Imports
import sys
sys.path.append('/Users/beatajohansson/Desktop/ROLO/utils')
...
class ROLO_TF:
    ...
    rolo_weights_file = '/Users/beatajohansson/Desktop/ROLO/weights/lstm/model_step6_exp_1.ckpt'
    lstm_depth = 3
    ...
    def train_20(self):
        print("TRAINING ROLO...")
        log_file = open("output/training_experiment_1.txt", "a+") #open in append mode
        self.build_networks()
